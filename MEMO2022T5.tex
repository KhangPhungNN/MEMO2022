...
\begin{tikzpicture}[line cap=round,line join=round,>=triangle 45,x=1cm,y=1cm]
	...
	\begin{scriptsize}
		...
		\draw [fill=uuuuuu] (4.254900338131543,4.451784662984424) circle (2pt);
		\draw[color=uuuuuu] (4.343619412498325,4.807256005350745) node {\normalsize$M$};
	\end{scriptsize}
\end{tikzpicture}
...
Kẻ $AG$ là đường kính của $(O)$. $BD$ cắt $AC$ tại $M$.\\

Ta có $BG\parallel AC$, $M$ là trung điểm $AC$.\\
$\Rightarrow -1=B(AC,MG)=B(AC,DG)$ (Xét phép chiếu tâm $B$)\\

Suy ra $(AC,DG)=-1$ vậy có tứ giác $ADCG$ là tứ giác điều hoà. Do đó tiếp tuyến tại $D,\space G$ và $AC$ đồng quy. Vậy $XG$ là tiếp tuyến tại $G$ của $(O)$.\\

Tương tự, ta chứng minh đượng $YG$ là tiếp tuyến tại $G$ của $(O)$.\\

Vậy $XY$ tiếp xúc với đường tròn $(O)$.
\end{document}
